...
namespace ghostCodes.Configs
{
    ...
    {
        public static ConfigFile Setup = new(Path.Combine(Paths.ConfigPath, $"ghostCodes.Setup.cfg"), true);
        ...
        public static ConfigEntry<bool> UseSecondaryInteractionsConfig { get; internal set; }
        ...
        internal static void Init()
        {
            ...
            UseSecondaryInteractionsConfig = MakeBool(Setup, "Mode", "UseSecondaryInteractionsConfig", false, "Enable this to create/use a secondary 'Interactions' Config to identify different chances for your secondary mode.");
            ...
            {
                if (PrimaryMode.Value == "Hauntings")
                {
                    PrimaryMode.Value = "Insanity";
                    if (SecondaryMode.Value == PrimaryMode.Value)
                        SecondaryMode.Value = "None";

                    Plugin.GC.LogWarning("NETWORKING IS DISABLED! Primary Mode changed to Insanity");
                }
            }
        ...
        internal static void OnSettingChanged(object sender, SettingChangedEventArgs settingChangedArg)
        {
            ...
            if (settingChangedArg.ChangedSetting.Definition == UseSecondaryInteractionsConfig.Definition)
            {
                if ((bool)settingChangedArg.ChangedSetting.BoxedValue)
                {
